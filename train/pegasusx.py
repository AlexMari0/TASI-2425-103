...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--qg_model", type=str, default="google/pegasus-x-large") # Atau jalur lokal Anda
    parser.add_argument("--pad_mask_id", type=int, default=-100)
    parser.add_argument("--save_dir", type=str, default="/home/samuel/tasi2425103/revisi/model/final_pegasusx/")
...
# ============================ #
# Penjelasan: Fungsi ini sekarang menggunakan AutoModelForConditionalGeneration
# untuk memuat model. Ini adalah praktik terbaik karena AutoModel akan secara
# otomatis mendeteksi tipe model (misalnya, pegasus_x) dari konfigurasi checkpoint
# dan memuat kelas yang paling tepat, menghindari peringatan yang muncul sebelumnya.
def get_model(checkpoint: str, device: str, tokenizer) -> PegasusForConditionalGeneration: # Ganti tipe hint di sini
    # --- PERUBAHAN DI SINI ---
...
# ============================ #
# ... (kode load_and_combine_datasets tidak berubah) ...
